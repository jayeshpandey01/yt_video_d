  ...
  return (
    <ThemeProvider theme={theme}>
      ...
      <Box sx={{ display: 'flex' }}>
          ...
          <Toolbar sx={{ pr: '24px' }}>
            ...
            {isHomePage && (
              <Stack direction="row" spacing={2} sx={{ display: { xs: 'none', md: 'flex' }, mr: 2 }}>
                <Button color="inherit" onClick={() => document.getElementById('features')?.scrollIntoView({ behavior: 'smooth' })}>
                  Features
                </Button>
                <Button color="inherit" onClick={() => document.getElementById('how-it-works')?.scrollIntoView({ behavior: 'smooth' })}>
                  How to use
                </Button>
                <Button color="inherit" onClick={() => document.getElementById('faq')?.scrollIntoView({ behavior: 'smooth' })}>
                  FAQ
                </Button>
              </Stack>
            )}
        ...
        <Drawer variant={isHomePage ? "temporary" : "permanent"} open={open} onClose={() => setOpen(false)}>
          <Toolbar
            sx={{
              display: 'flex',
              alignItems: 'center',
